...
define([
  'SuiteScripts/Transactions/Vendor Bill/Modules/diverse_Module_setAllocationAmountsOnExpensesLine',
], (setAllocationExpensesLine) => {
  ...
  const beforeSubmit = (scriptContext) => {
    ...
    try {
      ...
      if (scriptContext.type !== scriptContext.UserEventType.DELETE) {
        setAllocationExpensesLine.beforeSubmit(scriptContext);
      }
    } catch (error) {
      log.error(loggerTitle + ' caught an exception', error);
    }
