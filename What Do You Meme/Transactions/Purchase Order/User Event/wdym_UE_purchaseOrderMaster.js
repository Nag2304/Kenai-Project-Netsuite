...
define([
  ...
  'N/search',
  'N/format',
  'SuiteScripts/Transactions/Purchase Orders/Modules/wdym_Module_setPoExFactoryDate',
  'SuiteScripts/Transactions/Purchase Orders/Modules/wdym_Module_updateDateOnVendorChange',
], (record, search, format, setPoExFactoryDate, updateDateOnVendorChange) => {
  ...
  const beforeSubmit = (scriptContext) => {
    ...
    try {
      ...
      //
      setPoExFactoryDate.beforeSubmit(scriptContext);
      updateDateOnVendorChange.beforeSubmit(scriptContext);
    } catch (error) {
