...
define(['N/render', 'N/record', 'N/file', 'N/config'], (
  ...
  const onRequest = (scriptContext) => {
    ...
    try {
      ...
      const salesOrderInternalId = scriptContext.request.parameters.recId;
      //
      ...
      const salesOrderId = salesOrderRecord.save();
      log.audit(
        loggerTitle,
        ' Sales Order Record Saved Successfully: ' + salesOrderId
      );
      //
    } catch (error) {
