...
/**
 * File name: hms_MR_addDuplicatesToAgentUpdateProjectEmail.js
 * Script: HMS | MR Add Duplicates To Agent Email
...
define(['N/record', 'N/search'], (record, search) => {
    ...
    const map = (mapContext) => {
        ...
        try {
            ...
            // Agent Email
            if (agentEmail) {
                mapContext.write({ key: agentEmail, value: reduceValues });
            }
            //
        } catch (error) {
        ...
        try {
            ...
            if (values.length > 1) {
                ...
                for (let index = 0; index < values.length; index++) {
                    ...
                    log.emergency(loggerTitle, ' Agent Project Update Record: ' + agentProjectUpdateRecordId);
