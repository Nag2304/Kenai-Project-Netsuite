...
/**
 * File name: hms_MR_mergeAgent17DuplicateRecords.js
 * Script: HMS | MR Merge Agent 17 Duplicate Record
...
define(['N/search', 'N/record', 'N/runtime'], (search, record, runtime) => {
  ...
  const reduce = (reduceContext) => {
    ...
    try {
      ...
      // Read the Values
      const agentIdNumber =
        reduceContextValues.values['GROUP(custrecord_hms_agent_id_number_17)'];
  ...
  const searchAgentDuplicateswithTwoRecords = () => {
    ...
    if (agentIdParameter) {
      filtersArr = [
        ...
        ['isinactive', 'is', 'F'],
        'AND',
        ['custrecord_hms_agent_id_number_17', 'is', agentIdParameter],
      ];
    } else {
      filtersArr = [
        ['custrecord_hms_agent_id_dupe_17', 'is', 'T'],
  ...
  const getAgentRelatedRecords = (agentIdNumber) => {
    ...
    try {
      customAgentUpdateProjectSearchObj = search.create({
        type: 'customrecord_hms_agent_upd_prjct_reg_17',
        filters: [
          ['custrecord_hms_agent_id_number_17', 'is', agentIdNumber],
          'AND',
          ['custrecord_hms_agent_id_dupe_17', 'is', 'T'],
          'AND',
          ['isinactive', 'is', 'F'],
