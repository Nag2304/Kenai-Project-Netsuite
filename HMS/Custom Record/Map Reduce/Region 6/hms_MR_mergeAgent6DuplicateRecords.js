...
/**
 * File name: hms_MR_mergeAgent6DuplicateRecords.js
 * Script: HMS | MR Merge Agent 6 Duplicate Record
...
define(['N/search', 'N/record', 'N/runtime'], (search, record, runtime) => {
  ...
  const reduce = (reduceContext) => {
    ...
    try {
      ...
      // Read the Values
      const agentIdNumber =
        reduceContextValues.values['GROUP(custrecord_hms_agent_id_number_6)'];
  ...
  const searchAgentDuplicateswithTwoRecords = () => {
    ...
    if (agentIdParameter) {
      filtersArr = [
        ...
        ['isinactive', 'is', 'F'],
        'AND',
        ['custrecord_hms_agent_id_number_6', 'is', agentIdParameter],
      ];
    } else {
      filtersArr = [
        ['custrecord_hms_agent_id_dupe_6', 'is', 'T'],
  ...
  const getAgentRelatedRecords = (agentIdNumber) => {
    ...
    try {
      customAgentUpdateProjectSearchObj = search.create({
        type: 'customrecord_hms_agent_upd_prjct_reg_6',
        filters: [
          ['custrecord_hms_agent_id_number_6', 'is', agentIdNumber],
          'AND',
          ['custrecord_hms_agent_id_dupe_6', 'is', 'T'],
          'AND',
          ['isinactive', 'is', 'F'],
