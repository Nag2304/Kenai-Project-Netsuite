...
/**
 * File name: hms_MR_keepAndPurgeEmailDuplicateRecordsForRegion4.js
 * Script: HMS | MR K & P For Region 4 Email Dup
...
define(['N/search', 'N/record'], (search, record) => {
  ...
  const map = (mapContext) => {
    ...
    try {
      ...
      // Key
      const email =
        mapContextValues.values['GROUP(custrecord_hms_agent_email_4)'];
      //
  ...
  const searchAgentDuplicateswithTwoRecords = () => {
    ...
    return search.create({
      ...
      columns: [
        search.createColumn({
          name: 'custrecord_hms_email_dupe_4',
          summary: 'GROUP',
