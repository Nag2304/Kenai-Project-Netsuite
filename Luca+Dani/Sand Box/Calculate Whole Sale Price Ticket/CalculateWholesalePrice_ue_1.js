    		...
    		log.debug('item--'+i,itemid);
        		...
        		var itemSearchObj = search.create({
        			   ...
        			   [
        			      ...
        			      search.createColumn({name: "currency",join: "pricing",label: "Currency"}),
        			      search.createColumn({name: "internalid",join: "pricing",label: "Internal ID"}),
        			...
        			wholesale_price=result.getValue({name: "unitprice",join: "pricing",label: "Unit Price"});
